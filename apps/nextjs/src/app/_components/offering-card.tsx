...
const OfferingCard = ({
  ...
  return (
    <motion.div
      ...
      whileHover="hover"
      animate="rest"
      className={`flex flex-col items-center border-b-2 border-matteBlack p-10 ${index === lastOfferingIndex ? "border-b-0 md:border-b-0" : ""} ${index === lastOfferingIndex - 1 ? "border-b-0 md:border-b-0" : ""} last:border-b-0 `}
    >
      <motion.div
